  ...
  try {
    ...
    client.on('messageCreate', async (message) => {
      ...
      try {
        ...
        import('./graphai-engine').then(async (module) => {
          ...
          logAppError('GraphAI Engine Import', error);
          message.reply('GraphAIエンジンの読み込み中にエラーが発生しました。管理者はログを確認してください。')
    ...
    client.once('ready', () => {
      ...
      supabase
        ...
        .then(() => console.log('Bot status updated to online'))
        .catch(err => console.error('Failed to update bot status:', err));
    });
